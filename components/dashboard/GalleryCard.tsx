            ...
            <>
              ...
              <div className="flex gap-1.5">
                ...
                <button
                  ...
                  title={c.selections}
                  className="shrink-0 flex items-center justify-center border border-white/10 text-white/70 rounded-lg px-3 py-2 hover:bg-[#2D6A6A]/15 hover:border-[#2D6A6A]/40 hover:text-[#33A39A] transition-all"
                >
            ...
            <div className="flex items-start justify-between p-5 border-b border-white/[0.08]">
              <div>
                <h3 className="font-semibold text-white flex items-center gap-2">
                  <svg className="w-4 h-4 text-[#33A39A]" viewBox="0 0 24 24" fill="currentColor"><path d="M21 8.25c0-2.485-2.099-4.5-4.688-4.5-1.935 0-3.597 1.126-4.312 2.733-.715-1.607-2.377-2.733-4.313-2.733C5.1 3.75 3 5.765 3 8.25c0 7.22 9 12 9 12s9-4.78 9-12z" /></svg>
                  {c.selectionsTitle}
                </h3>
              ...
              {selLoading ? (
                ...
                <>
                  <p className="text-xs text-white/50 mb-3">
                    <span className="text-[#33A39A] font-semibold">{selPhotos.length}</span> {c.photosSelected}
                  </p>
                  <ul className="space-y-1">
                    {selPhotos.map((p) => (
                      <li key={p.id} className="flex items-center gap-2 text-sm text-white/80 bg-white/[0.03] rounded-lg px-3 py-2">
                        <svg className="w-3.5 h-3.5 text-[#33A39A] shrink-0" viewBox="0 0 24 24" fill="currentColor"><path d="M21 8.25c0-2.485-2.099-4.5-4.688-4.5-1.935 0-3.597 1.126-4.312 2.733-.715-1.607-2.377-2.733-4.313-2.733C5.1 3.75 3 5.765 3 8.25c0 7.22 9 12 9 12s9-4.78 9-12z" /></svg>
